...
def generateVOC2Json(rootDir, xmlFiles):
    ...
    for root, dirs, files in os.walk(rootDir):
        ...
        for file in xmlFiles:
            ...
            if file in files:
                ...
                img = cv2.imread(r"C:\Users\nebot\Downloads\3IA\ELYADATA\data\TNDC Dataset\TNCR_Dataset\data\TNDC_Dataset/Images/valid/" + image['file_name'])
                if img is not None:
    ...
    print(len(images))
    print("full_lined : ", full_lined, " merged_cells : ", merged_cells, " nolines : ", nolines, " partial_lined : ",
          partial_lined)
    ...
    with open(r"C:\Users\nebot\Downloads\3IA\ELYADATA\data\TNDC Dataset\TNCR_Dataset\data\TNDC_Dataset/Output Json/val.json", "w") as f:
        f.write(jsonString)


# Path to the txt file (see at the top of this script)
trainFile = r"C:\Users\nebot\Downloads\3IA\ELYADATA\data\TNDC Dataset\TNCR_Dataset\data\TNDC_Dataset/ImageSets/main/val.txt"
trainXMLFiles = list()
...
rootDir = r"C:\Users\nebot\Downloads\3IA\ELYADATA\data\TNDC Dataset\TNCR_Dataset\data\TNDC_Dataset/Annotations"
